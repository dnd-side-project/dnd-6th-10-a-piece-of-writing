...
//    private String path = ":" + "8080" + "/api/v1/posts";
//    private String url;
...
//        logger.info("url : " + url);
//
//        // https://picsum.photos/ 참고해서 바꿀 것
////            MockMultipartFile image = new MockMultipartFile("file", "imagefile.jpeg", "image/jpeg",
////                "<<jpeg data>>".getBytes());
//
//        //when
////            try {
////                mvc.perform(
////                    multipart(url)
////                        .file(image).part(new MockPart("request", new ObjectMapper().writeValueAsString(requestDto).getBytes(
...
////            try {
////                mvc
////                    .perform(fileUpload(url)
////                        .file(image)
////                        .param("request", new ObjectMapper().writeValueAsString(requestDto))
//////                        .param("authorId", new ObjectMapper().writeValueAsString(requestDto))
////                        .header("X-AUTH_TOKEN", accessToken)
